...
def main():
    ...
    tests.append((
        "Warp Plugin Test",
        run_command("python3 plugins/warp/src/main.py test --hours 1", "Testing Warp plugin functionality")
    ))
    
    tests.append((
        "Warp Session Analysis",
        run_command("python3 plugins/warp/src/main.py analyze --hours 24", "Testing Warp usage analytics")
    ))
    
    tests.append((
        "Warp Recovery Script",
        run_command("python3 plugins/warp/src/main.py recover --hours 1", "Testing recovery script generation")
    ))
    ...
    tests.append((
        ...
        run_command("python3 plugins/windsurf/src/main.py test", "Testing Windsurf context routing")
    ))
    
    tests.append((
        "Windsurf Command Enhancement",
        run_command("python3 plugins/windsurf/src/main.py enhance --cmd 'git status'", "Testing command enhancement")
    ))
    
    # 6. AI Integration Test
    tests.append((
        "AI Plugin Test",
        run_command("python3 plugins/ai/tgpt/integration.py test", "Testing AI integration framework")
    ))
    
    # 7. Unified CLI Command Tests
    tests.append((
        "Unified Warp Recovery",
        run_command("python3 unified_cli.py warp recover 1", "Testing Warp recovery via unified CLI")
    ))
