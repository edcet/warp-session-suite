...
class PearAIPlugin(BasePlugin):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.capabilities = ["ai_assistance", "code_generation", "session_sync", "intelligent_completion"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('command', choices=['test', 'generate', 'assist', 'sync'], 
